...
const examples = [
  {
    label: 'Simple mask',
    code: `<input v-maska data-mask="#-#" value="12">`
  },
  {
    label: 'Phone mask',
    code: `<input v-maska data-mask="+1 ### ###-##-##">`
  },
  {
    label: 'HEX-color',
    code: `<input\n  v-maska\n  data-mask="!#HHHHHH"\n  data-mask-tokens="H:[0-9a-fA-F]"\n>`
  },
  {
    label: 'IP address with optional digits',
    code: `<input\n  v-maska\n  data-mask="#00.#00.#00.#00"\n  data-mask-tokens="0:[0-9]:optional"\n>`
  },
  {
  ...
  },
  {
    ...
    code: `<input\n  v-maska\n  data-mask="9 99#.##"\n  data-mask-tokens="9:[0-9]:repeated"\n  data-mask-reversed\n>`
  }
]
